...
import {minuteTemplate} from '../templates/timesTemplate.js';
import weekNumbersTemplate from '../templates/weekNumbersTemplate.js';
import ViewTime from './ViewTime.js';

export default class MinutesView extends ViewTime {
  constructor(picker) {
    super(picker, {
      id: 3,
      name: 'minutes',
  ...
  init(options, onConstruction = true) {
    if (onConstruction) {
      const inner = parseHTML(minuteTemplate).firstChild;
  ...
  updateSelection() {
    const {times = {minute: 0}} = this.picker.datepicker;
    this.selected = times.minute;
  }
