...
import pickerWrapperTemplate from './templates/pickerWrapperTemplate.js';
import DaysView from './views/DaysView.js';
import MonthsView from './views/MonthsView.js';
import YearsView from './views/YearsView.js';
import HoursView from './views/HoursView.js';
import MinutesView from './views/MinutesView.js';
import SecondsView from './views/SecondsView.js';
import {
...
export default class Picker {
  constructor(datepicker) {
    ...
    registerListeners(datepicker, [
      ...
      [timeMain, 'click', onClickViewTime.bind(null, datepicker)],
    ...
    Object.values(this.timeViews).forEach(view => {
      view.render();
